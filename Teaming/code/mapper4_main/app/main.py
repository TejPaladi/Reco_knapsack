...
def initialize():
    ...
    code_to_term = pickle.load(open(home_dir+'code_to_term.pickle', 'rb'))

    # A map from ACM Classification Terms to their corresponding codes
    term_to_code = pickle.load(open(home_dir+'term_to_code.pickle', 'rb'))
    jel_term_to_code = pickle.load(open(home_dir+'jel_term_to_code.pk', 'rb'))
    jel_code_to_term = pickle.load(open(home_dir+'jel_code_to_term.pk', 'rb'))
...
jel_dict = {}
with open(home_dir+'jel_dict.pk', 'rb') as f:
